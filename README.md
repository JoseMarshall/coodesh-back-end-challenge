...
Você está livre para usar Node.js ou C# .NET Core ou PHP Laravel ou RubyOnRails ou Go Lang ou Python FastAPI no desenvolvimento da solução deste tech challenge.
